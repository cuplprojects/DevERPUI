...
const AddProjectModal = ({
  ...
  const handleProjectNameChange = (e) => {
    ...
    // Make sure selectedExamType is an array before using map
    const selectedExamTypeNames = Array.isArray(selectedExamType)
      ? selectedExamType.map(e => e.typeName).join(', ')
      : '';
  ...
  const handleSubmit = async (event) => {
    ...
    // Make sure selectedExamType is an array before using map
    const selectedExamTypeIds = Array.isArray(selectedExamType)
      ? selectedExamType.map(exam => exam.examTypeId)
      : [];
    ...
    >
      ...
      <Modal.Body className={`${customLight}`}>
        <Form id="addProjectForm" onSubmit={handleSubmit} form={form}>
          ...
          {/* Series section when type is booklet */}
            ...
            <Col xs={12}>
              <Form.Group controlId="name">
                ...
                <Form.Control
                  ...
                  disabled={!selectedGroup || !selectedType || !selectedSession || !Array.isArray(selectedExamType) || selectedExamType.length === 0}
