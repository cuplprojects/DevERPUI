    ...
    >
      <Row>
        ...
        <Col
          ...
          sm={12}
          xm={12}
          className={`content-area rounded-end-4 ${customMid} shadow-`}
        >
          {hasPermission("2.1.1") && selectedMenu === "RolePage" && (
            <RolesAndDepartments />
          )}
          {hasPermission("2.1.2") && selectedMenu === "addUser" && <AddUsers />}
          {hasPermission("2.1.3") && selectedMenu === "allUsers" && (
            <AllUsers />
          )}
          {hasPermission("2.1.4") && selectedMenu === "questions" && (
            <SecurityQuestions />
          )}
