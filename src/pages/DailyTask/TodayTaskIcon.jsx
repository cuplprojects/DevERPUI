...
const NoticeBoard = ({ show, onHide, dispatchData }) => {
    ...
    return (
        ...
        >
            ...
            {/* <Offcanvas.Header closeButton className={`${customLightBorder}`}>
        <Offcanvas.Title className={`${customDarkText} d-flex justify-content-between align-items-center`}>
            <div> {t("todaysTasks")}</div>
